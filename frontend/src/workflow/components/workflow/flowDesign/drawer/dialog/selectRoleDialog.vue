<template>
    <el-dialog title="选择角色" v-model="visibleDialog" :style="{ width: dialogSize + 'px' }" append-to-body>
        <el-row :gutter="10">
            <el-col :span="16">
                ...
                <el-table ref="refTable" :data="roleList" border height="475px" :row-style="{ height: '30px' }">
            ...
            <el-col :span="8">
                <p class="tip">已选中列表</p>
                <el-table ref="selectedTable" :data="checkedRoleList" border height="488px">
                    <el-table-column label="操作" width="60" align="center" class-name="small-padding fixed-width">
                        <template #default="scope">
...
import { getRoles } from "@/workflow/api/workflow";
