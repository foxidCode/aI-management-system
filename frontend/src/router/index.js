...
const routes = [
  ...
  { path: '/callback', component: OAuthCallback },
  {
    ...
    children: [
      ...
      { path: 'permission-change-log', component: () => import('../views/PermissionChangeLog.vue') },
      { path: 'alerts', component: () => import('../views/AlertManagement.vue') },
      { path: 'ai-config', component: () => import('../views/AiConfig.vue') },
      { path: 'ai-summaries', component: () => import('../views/AiSummaryManagement.vue') },
      { path: 'ai-knowledge', component: () => import('../views/AiKnowledgeBase.vue') },
      { path: 'ai-sessions', component: () => import('../views/AiSessionManagement.vue') },
